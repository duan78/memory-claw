...
import { DEFAULT_CONFIG, DEFAULT_DB_PATH, OLD_TABLE_NAME, ERROR_BACKOFF_THRESHOLD, ERROR_BACKOFF_DURATION, MAX_ERRORS_PER_HOUR, POLLING_INTERVAL } from "./config.js";
...
const plugin = {
    ...
    register(api) {
        ...
        api.logger.info(`memory-claw v2.4.55: Registered (db: ${dbPath}, model: ${embedding.model}, vectorDim: ${vectorDim}, CRITICAL FIX: error backoff, DB integrity check, circuit breaker, polling 30s, locales: ${activeLocales.length})`);
