...
const plugin = {
    ...
    register(api) {
        ...
        api.logger.info(`memory-claw v2.4.41: Registered (db: ${dbPath}, model: ${embedding.model}, vectorDim: ${vectorDim}, multi-hook strategy, rate-limited logging, locales: ${activeLocales.length})`);
