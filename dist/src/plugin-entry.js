...
const plugin = {
    ...
    register(api) {
        ...
        api.logger.info(`memory-claw v2.4.42: Registered (db: ${dbPath}, model: ${embedding.model}, vectorDim: ${vectorDim}, per-hook tracking, counter overflow protection, locales: ${activeLocales.length})`);
