...
const plugin = {
  ...
  register(api: OpenClawPluginApi) {
    ...
    // v2.4.54: Enhanced hook tracking with timing information and discovery
    interface HookTracking {
      ...
      lastFiredAt: number;
      eventStructure?: string; // Store sample event structure for diagnostics
    }
