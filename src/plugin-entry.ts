...
const plugin = {
  ...
  register(api: OpenClawPluginApi) {
    ...
    api.logger.info(
      `memory-claw v2.4.48: Registered (db: ${dbPath}, model: ${embedding.model}, vectorDim: ${vectorDim}, CRITICAL FIX: agent_end detection + message_sent overflow fix, locales: ${activeLocales.length})`
    );
